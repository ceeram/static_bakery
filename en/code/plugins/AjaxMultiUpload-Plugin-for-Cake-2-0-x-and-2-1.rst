...
/CakePHP-AjaxMultiUpload/zipball/master`_

or checkout the code (leave the Password field blank):

``` git clone `https://srs81@github.com/srs81/CakePHP-
AjaxMultiUpload.git`_ ```
...
This uses the Ajax Upload script from: `http://valums.com/ajax-
upload/`_ and file icons from:
...
.. meta::
    :title: AjaxMultiUpload Plugin for Cake 2.0.x and 2.1
    :description: CakePHP Article related to plugin,upload,Files,Plugins
    :keywords: plugin,upload,Files,Plugins
